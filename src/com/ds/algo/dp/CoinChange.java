...
public class CoinChange {
    ...
    public static int coinChange(int[] coin,int N,int n)
    {
        ...
        int include=coinChange(coin,N-coin[n],n);
    ...
    public static void main(String[] args) {
        int res=CoinChange.coinChange(new int[] {2,8,7,6},10,3);
        System.out.println(" Recursive Approach : Coins change can be in : "+res+" ways");
        int result=CoinChange.coinChangeDP(new int[] {2,8,7,6},10);
        System.out.println("Coins change can be in : "+result+" ways");
    }
}
